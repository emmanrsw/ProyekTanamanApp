...
<body>
    <nav class="navbar navbar-expand-lg navbar-light">
        <a class="navbar-brand" href="{{ Auth::guard('pelanggan')->check() ? route('home') : route('login.register') }}"><span>Tanam</span><span class="highlight">.in</span></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item"><a class="nav-link" href="{{ Auth::guard('pelanggan')->check() ? route('home') : route('login.register') }}">Home</a></li>
    ...
    <section class="banner">
        <div class="banner-text">
            ...
            <p>Temukan semua yang perlu Anda ketahui tentang tanaman Anda, perlakukan mereka dengan baik dan mereka akan
                menjaga Anda.</p>
            <a href="{{ Auth::guard('pelanggans')->check() ? route('listTanaman') : route('register') }}" class="btn-custom">
        </div>
