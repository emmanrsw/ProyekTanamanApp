...
Route::any('/otp/verify/{idCust}', [OtpController::class, 'showOtpForm'])->name('otp.verification');
Route::post('/otp/verify/{idCust}', [OtpController::class, 'verifyOtp'])->name('otp.verify');
